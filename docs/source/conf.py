...
# anomaly_detection_pipeline documentation build
...
from anomaly_detection_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "anomaly_detection_pipeline"
author = "Kedro"
...
htmlhelp_basename = "anomaly_detection_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "anomaly_detection_pipeline.tex",
        "anomaly_detection_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "anomaly_detection_pipeline",
        "Project anomaly_detection_pipeline codebase.",
        "Data-Science",
    )
]
